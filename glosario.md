...
| **Omatidio** | Unidad individual del ojo compuesto. Más omatidios = mejor visión. |
| **Mandíbula** | Pieza bucal usada para cortar, transportar y manipular objetos. |
| **Mesopleura** | Parte lateral del tórax (mesosoma). |
| **Glándula metapleural** | Glándula antibiótica ubicada en la parte posterior del tórax. Ausente en Formicinae. |

---

## Castas y estructura social

| Término | Definición |
|---------|-----------|
| **Obrera menor (minor)** | Casta de obreras más pequeña. Generalmente forrajeras y cuidadoras de cría. |
| **Obrera media** | Casta intermedia entre menores y soldados. Versátil. |
| **Soldado (major)** | Casta de obreras más grande, con cabeza hipertrofiada. Defensa y procesado de alimento. |
| **Nanitic** | Primera generación de obreras, más pequeñas que las normales. Producidas con las reservas limitadas de la reina. |
| **Repleta / Mielera** | Obrera con gáster enormemente distendido que almacena líquidos azucarados para la colonia. Presente en *Brachymyrmex giardii* y *Myrmecocystus*. |
| **Intercasta** | Individuo con características intermedias entre obrera y reina. |
| **Ergatoide** | Reina sin alas, con aspecto similar a una obrera pero con capacidad reproductiva. |
| **Monógina** | Colonia con una sola reina. |
| **Polígina** | Colonia con múltiples reinas. |
| **Polimorfismo** | Variación de tamaño y forma entre obreras de la misma colonia. |
| **Monomorfa** | Sin variación significativa de tamaño entre obreras. |
| **Dimórfica** | Dos castas de obreras claramente diferenciadas (menores y mayores). |

---

## Reproducción y fundación

| Término | Definición |
|---------|-----------|
| **Vuelo nupcial** | Evento reproductivo donde reinas vírgenes y machos alados salen del nido para aparearse en el aire. |
| **Fundación claustral** | La reina funda la colonia sola, sin salir a buscar alimento. Usa sus reservas musculares alares como fuente de energía y proteína. |
| **Fundación semi-claustral** | La reina necesita salir a buscar alimento durante la fundación. |
| **Haplometrosis** | Fundación por una sola reina. |
| **Pleometrosis** | Fundación cooperativa por múltiples reinas. |
| **Poliandria** | La reina se aparea con múltiples machos. |
| **Huevo trófico** | Huevo no viable producido como alimento para larvas u otras obreras. Presente en *Acanthomyrmex*. |
...
| Término | Definición |
|---------|-----------|
| **Parabiosis** | Coexistencia pacífica de dos especies diferentes en el mismo nido o nidos conectados. Ej: *C. morosus* + *Solenopsis gayi*. |
| **Hermetismo** | Agresividad extrema de una colonia hacia cualquier individuo externo, incluso de la misma especie. |
| **Trofobiosis** | Relación mutualista donde las hormigas protegen insectos (áfidos, cochinillas) a cambio de melaza. |
| **Forrajeo solitario** | Cada obrera busca alimento individualmente, sin formar columnas. |
| **Forrajeo cooperativo** | Las obreras forman columnas o reclutan compañeras hacia fuentes de alimento. |
| **Lestobiosis** | Parasitismo donde una especie pequeña roba alimento de los nidos de una especie más grande. |

---

## Ciclo de vida y cría
...
| **Buche social** | Órgano pre-estomacal de las hormigas que actúa como tanque de almacenamiento compartido. El alimento ahí no se digiere — se mantiene disponible para compartir mediante trofalaxia. |
| **Mielada** | Secreción líquida azucarada excretada por pulgones, cochinillas y escamas al alimentarse de savia vegetal. Principal fuente de carbohidratos para muchas hormigas en la naturaleza. |
...
| Término | Definición |
|---------|-----------|
| **Granívora** | Especie que se alimenta principalmente de semillas. Ej: *Messor*, *Pogonomyrmex*. |
| **"Pan de hormiga"** | Pasta nutritiva producida al triturar semillas con las mandíbulas. Alimento procesado para larvas y reina. |
| **Néctar artificial** | Solución de azúcar + vitaminas usada como sustituto de miel o melaza. |
| **Trófico** | Relativo a la alimentación. "Huevo trófico" = huevo como alimento. |
