...
| Género | *Camponotus* |
| Especie | *fedtschenkoi* Mayr, 1877 |
| Distribución natural | Asia Central y del Sur: Kazajistán, Mongolia, Uzbekistán, Turkmenistán, noroeste de China |
| Hábitat | Estepas áridas, semidesiertos, suelo bajo piedras |

> ⚠️ Frecuentemente confundida con *Camponotus turkestanus* por similitud morfológica y solapamiento de hábitat. La taxonomía de esta especie ha generado confusión en el mercado de crianza entre 2001 y 2019.

---

## Morfología y polimorfismo

Especie **altamente polimorfa** con una de las variaciones de color más llamativas del género. Las obreras menores son casi translúcidas, mientras los soldados tienen cabeza negra brillante contrastando con cuerpo amarillo.

| Casta | Tamaño | Coloración |
|-------|--------|------------|
| Obrera menor (nanitic) | 4–6 mm | Casi translúcida, amarillo muy pálido, patas casi invisibles |
| Obrera media | 7–10 mm | Amarillo brillante con marcas ligeramente más oscuras |
| Soldado (major) | 10–12 mm | **Cabeza negra brillante**, tórax y abdomen amarillo |
| Reina | 13–15 mm | Cabeza y tórax negro/marrón oscuro, **gáster amarillo vibrante** |
| Macho | 7–9 mm | Alas, efímero |

**Rasgo diagnóstico principal:** Coloración dorada uniforme en obreras. Los soldados con cabeza negra y cuerpo amarillo son inconfundibles.

---

## Alimentación

### Proteínas (cada 2–3 días en temporada activa)
- Insectos vivos o recién muertos: grillos pequeños, cucarachas, moscas, tenebrios, gusanos de búfalo
- Pollo cocido sin sal (ocasional)
...
| Temporada | Recomendación |
|-----------|--------------|
| Primavera | Aumentar proteínas para impulsar el crecimiento |
| Verano | Dieta equilibrada normal |
| Otoño | Reducir proteínas gradualmente |
| Invierno (diapausa) | Principalmente carbohidratos, proteína mínima (80%/20%) |

### Agua
- Siempre disponible. Bebedero con algodón húmedo o piedras.
...
| Primeras obreras (nanitics) | 4–6 semanas | 3–12 obreras |
| Fin del año 1 | — | 50–100 obreras |
| Año 3 | — | ~500 obreras |
| Colonia madura en cautiverio | 3–5 años | ~2,000 obreras |
| Máximo en naturaleza | — | ~4,000 obreras |

> Crecimiento **medio** comparado con otras *Camponotus* asiáticas. Los primeros soldados aparecen generalmente al alcanzar 40–50 obreras, alrededor del mes 14.
...
| Etapa | Obreras |
|-------|---------|
| Mínimo para trasladar al nido | ~10–20 |
| Primeros soldados | ~40–50 |
| Colonia funcional | ~200–500 |
| Colonia madura en cautiverio | ~2,000 |
| Máximo en naturaleza | ~4,000 |

---

## Nidificación

- **En naturaleza:** Suelo bajo piedras en estepas áridas y semidesiertos.
...
| Criterio | Valoración |
|----------|-----------|
| Dificultad general | ⭐⭐ Principiante con experiencia previa |
...
5. **Confundirla con *C. turkestanus*** → revisar coloración exacta y procedencia del vendedor.
6. **Vibraciones** → extremadamente sensibles; un nido cerca de altavoces o pasos frecuentes puede hacer que la reina coma los huevos.
...
- Antsrus.com: [C. fedtschenkoi care sheet](https://www.antsrus.com/product-page/camponotusfedtschenkoi)
- Best Ants UK: [C. fedtschenkoi care guide](https://www.bestantsuk.com/post/camponotus-fedtschenkoi-care-guide-essential-tips-from-expert-ant-keepers)
- AntWiki: [Camponotus fedtschenkoi](https://www.antwiki.org/wiki/Camponotus_fedtschenkoi)
