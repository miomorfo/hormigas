...
| Género | *Camponotus* |
| Especie | *morosus* Smith, 1858 |
| Distribución natural | Chile (Antofagasta a Magallanes), Argentina |
| Hábitat | Matorral esclerófilo de Chile central |

---

## Morfología y polimorfismo

Especie de **gran tamaño**, una de las más grandes y comunes de Chile. Coloración negra dominante con antenas de color **rojo ferruginoso** — rasgo diagnóstico clave. Polimorfismo marcado con soldados de cabeza muy robusta.

| Casta | Tamaño | Características |
|-------|--------|-----------------|
| Obrera menor | 5–9 mm | Forrajeras principales |
| Soldado (major) | 9–14 mm | Cabeza ancha, mandíbulas fuertes, defensa |
| Reina | 13–15 mm | Cuerpo robusto, negra |
| Macho | 9–12 mm | Alas, antenas largas, efímero |

**Coloración:** Negra con **flagelo (antenas) ferruginoso (rojo-anaranjado)**. Dorso del abdomen con pubescencia escasa, corta y blanca que no oculta la superficie — contrasta con *C. chilensis* que tiene pubescencia dorada densa.

**Clave de identificación:** Lado de la cabeza sin pelos erectos visibles (o con muy pocos en la esquina occipital y base de mandíbula). Gena densamente punteada, opaca. Antenas rojizas. No confundir con *C. morosus* vs *C. chilensis*: esta última tiene vellos dorados abundantes en el gáster.
...
| Ítem alimenticio | % del total |
|-----------------|-------------|
| Insectos (90.8% muertos, 9.2% vivos) | ~41% |
| Excrementos de aves y reptiles | ~36% |
| Materia vegetal | ~23% |

> Las larvas y la reina requieren proteínas para crecer y reproducirse. Las obreras adultas solo necesitan azúcares para su metabolismo general — esto explica la alta proporción de insectos muertos y excrementos ricos en nitrógeno.

Se ha observado también forrajeo sobre **carroña de bovino** (transportando restos de pupas de insectos cadavéricos, piel y pelo), y atención a **pulgones** (Aphididae), **cochinillas** (Pseudococcidae) y **escamas** (Coccidae) como fuente de melaza (Cerpa, 2017).

### En cautiverio — Proteínas (2–3 veces por semana)
- Insectos vivos o congelados: grillos, moscas, tenebrios, cucarachas (Blaptica dubia)
...
> **Dato de campo:** Cada obrera forrajera puede recorrer en promedio hasta **2 metros desde el nido** en sus incursiones de búsqueda de alimento (Grez, 1986).
...
|------|--------------------|--------------------|
| Fundación (reina sola) | 2–4 meses | 1 reina |
| Primeras obreras (nanitics) | 1–2 meses | 3–15 obreras |
| Colonia joven | 6–18 meses | 15–200 obreras |
| Colonia establecida | 1–3 años | 200–800 obreras |
| Colonia madura | 3+ años | 800–2,000+ obreras |

**Ciclo de metamorfosis (huevo → adulto):** ~45–60 días a temperatura óptima.
...
|------|-----------------|-----------------|
| Zona de cría (nido) | 20–25 °C | 16–28 °C |
| Zona fría (arena) | 16–20 °C | 12–22 °C |

> Especie con distribución desde Antofagasta hasta Magallanes — muy adaptable a rangos térmicos amplios.
...
| Etapa | Obreras estimadas |
|-------|------------------|
| Mínimo viable | ~30–50 |
| Colonia funcional con soldados | ~200–300 |
| Colonia establecida en cautiverio | 500–1,500 |
| Máximo en naturaleza | 2,000+ |
...
| Criterio | Valoración |
|----------|-----------|
| Dificultad general | ⭐ Principiante-intermedio |
...
- Mayr, G. (1862). Myrmecologische Studien. — combinación en *Camponotus*.
...
- Ipinza-Regla, J., Galano, A. & Morales, M.A. (1993). Ámbito de hogar de *Camponotus morosus*. Sociedad Chilena de Entomología.
...
- Ipinza-Regla, J. et al. (2017). Hermetism between *C. morosus* and *Linepithema humile*. *Gayana*, 81: 22–27.
- Hidalgo, P. et al. (2024). Seasonal niche differentiation of *C. morosus* and *Dorymyrmex goetschi* in sandy beach habitats. *European Journal of Entomology*, 121: 347–354.
- Cerpa, P. (2017). Observaciones personales sobre forrajeo en carroña y trófobiontes.
- Snelling, R.R. & Hunt, J.H. (1975). The ants of Chile (Hymenoptera: Formicidae). *Rev. Chil. Entomol.* 9: 63–129.
- AntWiki: [Camponotus morosus](https://www.antwiki.org/wiki/Camponotus_morosus)
